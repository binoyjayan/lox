...
fn main() -> io::Result<()> {
    ...
    // Production
    // Base-Class: Tokens
    define_ast(outdir, &"Expr".to_string(), &vec![
...
fn define_ast(outdir: &String, base_name: &String, productions: &Vec<String>) -> io::Result<()> {
    ...
    for ty in &types {
        writeln!(file, "    fn visit_{}_{}(&self, expr: &{}) -> Result<T, LoxErr>;",
